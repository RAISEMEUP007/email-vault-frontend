<template>
  <div class="flex h-full items-center justify-center min-h-screen bg-gray-200 p-2">
    <div class="flex w-full max-w-1512px h-full max-h-982px">
      <div class="w-1/2 pt-24 pb-32 bg-white flex flex-col items-center justify-start p-2">
        <div class="p-1 pt-6 pb-8 mb-4 w-full max-w-md">
          ...
          <p class="mt-0.5 mb-5 text-lg pr-2">
            We’re almost set! A confirmation email was sent to “sarah.davis@nextgenlabs.com”.
          </p>
          <p class="mt-0.5 mb-5 text-lg pr-2">
          ...
          <div class="mt-4 text-center border-t shadow-zinc-500 mt-12 pt-6">
            ...
            <router-link class="text-evPurple hover:text-evPurpleAlt text-sm">Resend Email</router-link>
          </div>
        </div>
